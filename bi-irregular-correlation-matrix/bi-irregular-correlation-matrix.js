...
*/
define(["jquery", "./scripts/d3.min", "./scripts/irregularUtils", "css!./styles/bi-irregular-correlation-matrix.css"],
    function ($, d3) {
        'use strict';
        ...
        return {
            ...
            paint: function ($element, layout) {
                var debug = false;
                var enigma = $element.scope().component.model;
                ...
                return enigma.app.createSessionObject({
                    "qInfo": {
                        "qType": "HyperCube"
                    },
                ...
                .then(function (obj) {
                    ...
                    .then(function (layout) {
                        ...
                        return enigma.app.destroySessionObject(obj.id);
                    });
                }).catch(function(err) {
                    console.error(err);
                });
